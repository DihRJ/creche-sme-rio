...
> ✅ **Os dois itens do [`PARA-DEV-B.md`](PARA-DEV-B.md) estão fechados e no ar.** O login retoma a
> inscrição em andamento e a tela `/inscricoes` existe. O que o Dev B devolve ao time — inclusive
> um bug silencioso que atinge quem trabalha em Windows — está em
> [`PARA-O-TIME.md`](PARA-O-TIME.md).
